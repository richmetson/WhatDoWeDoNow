...
namespace AgonyBartender.Inventory
{
    ...
    public class InventoryGroup : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, ICanvasRaycastFilter
    {
        ...
        public void Update()
        {
            ...
            bool shouldShow = (IsPointerInside || ItemCursor.ActiveCursor) &&
                              transform.parent.GetComponent<CanvasGroup>().interactable;
        ...
        public void OnDrawGizmos()
        {
            ...
            Gizmos.matrix =
                Matrix4x4.TRS(transform.TransformPoint(RaycastCenterPoint), Quaternion.identity,
                    new Vector3(RaycastCenterScale.x, RaycastCenterScale.y, 1f))*mat;
